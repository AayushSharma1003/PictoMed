      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-24 sm:pt-24 sm:pb-32">
        <div className="text-center space-y-8">
          ...
          <h2 className="heading-xl text-foreground">
            ...
            <br />
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent pb-2 inline-block">
              For Everyone
            </span>
          </h2>
          
          <p className="mx-auto max-w-2xl text-lg md:text-xl text-muted-foreground">
            PictoMed combines advanced AI with medical expertise to provide accessible skin 
