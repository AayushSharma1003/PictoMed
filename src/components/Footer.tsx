      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2">
            <Link to="/" className="flex items-center space-x-2 text-foreground">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-primary to-accent flex items-center justify-center text-white font-bold">
                P
              </div>
              <span className="font-semibold text-xl">PictoMed</span>
            </Link>
            <p className="mt-4 text-muted-foreground text-sm leading-relaxed">
              PictoMed combines cutting-edge AI technology with healthcare expertise to provide accessible, reliable health assessments and support.
            </p>
            <div className="flex mt-6 space-x-5">
              <a href="https://github.com/pant-pragyan10/PictoMed" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="mt-12 border-t border-border pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} PictoMed. All rights reserved.
          </p>
