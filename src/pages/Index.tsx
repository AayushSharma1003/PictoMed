...
const Index = () => {
  ...
  const testimonials = [
    {
      quote: "PictoMed helped me identify my skin condition when I couldn't get a timely appointment with a dermatologist. The recommendations were spot-on.",
      author: "Sarah T.",
      role: "Eczema Patient",
    },
    {
        ...
        <div className="page-container">
          <div className="text-center space-y-3 mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              PictoMed offers a range of AI-powered healthcare services to help you understand and manage your health concerns.
            </p>
          </div>
            ...
            <div>
              <div className="space-y-6">
                <div className="inline-flex items-center space-x-2 rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary ring-1 ring-inset ring-primary/20">
                  <span>Why Choose PictoMed</span>
                </div>
                <h2 className="heading-lg">Healthcare Powered by Advanced AI</h2>
                <p className="text-muted-foreground">
                  PictoMed combines cutting-edge artificial intelligence with medical expertise to provide accessible, accurate health assessments and support.
                </p>
      ...
      <section className="page-section">
        <div className="page-container">
          <div className="text-center space-y-3 mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Hear from people who have used PictoMed to better understand and manage their health.
            </p>
          </div>
        ...
        <div className="page-container">
          <div className="rounded-2xl bg-gradient-to-r from-primary/10 to-accent p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              Take the first step towards better understanding your health with PictoMed's AI-powered tools and support.
            </p>
